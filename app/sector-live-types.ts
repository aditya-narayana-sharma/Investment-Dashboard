...
export const emptyBenchmarkSnapshot = (): SectorBenchmarkSnapshot => ({
  ...
  indices: [
    { id: "nifty-50", officialName: "NIFTY 50", family: "broad", level: null, returns: { day: null, week: null, month: null, quarter: null, halfYear: null, year: null }, indexedHistory: [], volatility: null, maxDrawdown: null, squeezeWidth: null, source: "NSE Indices canonical definition", sourceUrl: "https://www.niftyindices.com/reports/index-factsheet", observedAt: "Waiting for benchmark refresh", period: "Configured ticker waiting for market history", freshness: "unavailable" },
    ...
    { id: "nifty200-alpha-30", officialName: "NIFTY200 Alpha 30", family: "strategy", level: null, returns: { day: null, week: null, month: null, quarter: null, halfYear: null, year: null }, indexedHistory: [], volatility: null, maxDrawdown: null, squeezeWidth: null, source: "NSE Indices canonical definition", sourceUrl: "https://www.niftyindices.com/reports/index-factsheet", observedAt: "Waiting for benchmark refresh", period: "Definition only · no exact public Yahoo series (ETF proxies not substituted)", freshness: "unavailable" },
